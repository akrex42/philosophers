...
${ENDCOLOR}" ; ./philo 5 800 200 200 7 | grep 'Philosopher 5 is eating' | wc -l
print "${GREEN}./philo 5 800 200 200 7 | grep 'Philosopher 1 is eating' | wc -l
${ENDCOLOR}" ; ./philo 5 800 200 200 7 | grep 'Philosopher 1 is eating' | wc -l
print "${GREEN}./philo 5 800 200 200 7 | grep 'Philosopher 4 is eating' | wc -l
${ENDCOLOR}" ; ./philo 5 800 200 200 7 | grep 'Philosopher 4 is eating' | wc -l
